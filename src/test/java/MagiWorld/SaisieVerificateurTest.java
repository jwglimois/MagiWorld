...
class SaisieVerificateurTest {
    ...
    /**
     * Utilisation de l'objet Mock pour simuler la classe SaisieVerificateur qui vérifie si la saisie de l'utilisateur est un nombre entier (par exemple: 3).
    ...
    public void Given_InputOne_WhenAskQuestion_ThenGetOne() {
        ...
        assertEquals(testObjetMock(saisieVerificateur), 3);
    }

    /**
     * La fonction testObjetMock sera utilisé par l'objet Mock de la fonction Given_InputOne_WhenAskQuestion_ThenGetOne().
     ...
     */
    public int testObjetMock (SaisieVerificateur saisieVerificateur) {
        int reponse ;
        do{
